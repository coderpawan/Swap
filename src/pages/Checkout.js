        ...
        <div class="section section-padding">
          <div class="container">
            ...
            <form action="#" class="checkout-form learts-mb-50">
              ...
              <div class="col-12 learts-mb-20">
                <label for="bdCountry">
                  Country <abbr class="required">*</abbr>
                </label>
              ...
              <div class="col-12 learts-mb-20">
                <label for="bdAddress1">
                  Street address <abbr class="required">*</abbr>
                </label>
                <input
                  type="text"
                  id="bdAddress1"
              ...
              <div class="col-12 learts-mb-20">
                <label for="bdAddress2" class="sr-only">
              ...
              <div class="col-12 learts-mb-20">
                <label for="bdTownOrCity">
                  Town / City <abbr class="required">*</abbr>
                </label>
                <input type="text" id="bdTownOrCity" />
              </div>
              <div class="col-12 learts-mb-20">
                <label for="bdDistrict">
                  District <abbr class="required">*</abbr>
                </label>
